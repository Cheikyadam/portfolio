...
import { ionCloudUpload, ionCodeSlash, ionConstruct, ionLogoHtml5, ionPersonCircle, ionServer } from '@ng-icons/ionicons';
...
@Component({
  ...
  viewProviders: [provideIcons({ ionCodeSlash, ionLogoHtml5, ionServer, ionCloudUpload, ionConstruct, ionPersonCircle  })]
